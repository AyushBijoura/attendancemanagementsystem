...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\Attendace_managemnt_system\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\Attendace_managemnt_system\Attendance\-------Check atttendance-------"')
